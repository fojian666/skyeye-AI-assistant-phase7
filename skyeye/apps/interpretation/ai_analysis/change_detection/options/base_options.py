...
class BaseOptions():
    ...
    def init_data(self):
        dict_data = {
            'dataroot': r'I:\JZR\bianhuajiance_data\jintan4\jzr\train',
            'val_dataroot': r'I:\JZR\bianhuajiance_data\jintan4\jzr\val',
            'name': 'jintan4_jzr',
            'gpu_ids': [0],
    ...
    #     """定义训练和测试中使用的通用选项."""
    #     # basic parameters
    #     parser.add_argument('--dataroot', type=str, default=r'I:\JZR\bianhuajiance_data\jintan4\jzr\train',
    #                         help='path to images (should have subfolders A, B, label)')
    #     parser.add_argument('--val_dataroot', type=str, default=r'I:\JZR\bianhuajiance_data\jintan4\jzr\val',
    #                         help='path to images in the val phase (should have subfolders A, B, label)')
    #
    #     parser.add_argument('--name', type=str, default='jintan4_jzr',
    ...
    #     parser.add_argument('--json_name', type=str, default='train_val_test',
    #                         help='input the json name which contain the file names of images of different phase')
    #     parser.add_argument('--val_json_name', type=str, default='train_val_test',
    #                         help='input the json name which contain the file names of images of different phase')
    #     parser.add_argument('--ds', type=int, default='8', help='self attention module downsample rate')
    #     parser.add_argument('--angle', type=int, default=30, help='rotate angle')
    ...
    def gather_options(self):
        """
        使用基本选项初始化解析器（仅一次）。添加其他特定于模型和特定于数据集的选项。这些选项在<modify_commandline_options>函数中定义在模型和数据集类中。
        """
        # 检查是否已初始化
