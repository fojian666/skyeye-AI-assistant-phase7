...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='CDDataset_train', type=str)
    parser.add_argument('--data_name', default='LEVIR_train', type=str)
    # parser.add_argument('--dataset', default='dataset', type=str)
    # parser.add_argument('--data_name', default='test', type=str)
    # parser.add_argument('--data_name', default='LEVIR-CD dataset', type=str)
