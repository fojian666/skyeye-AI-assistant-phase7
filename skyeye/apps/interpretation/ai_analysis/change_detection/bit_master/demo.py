...
def get_args():
    ...
    parser.add_argument('--project_name', default='qinghai_CD_0829', type=str)
    parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
    parser.add_argument('--checkpoint_root', default=r'E:\geo_ai_server\gtrs_cs_server\change_detection\BIT_CD-master\checkpoints\qinghai_CD_0829', type=str)
    parser.add_argument('--output_folder', default='samples/predict', type=str)

    # data
    parser.add_argument('--num_workers', default=0, type=int)
    parser.add_argument('--dataset', default='CDDataset_predict', type=str)
    parser.add_argument('--data_name', default='LEVIR_predict', type=str)
...
if __name__ == '__main__':
    ...
    args.checkpoint_dir = args.checkpoint_root
