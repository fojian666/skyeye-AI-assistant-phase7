...
model_urls = {
    'resnet18': os.path.join(WORK_DIR, r"model/pre_train/resnet18-5c106cde.pth"),
    'resnet34': os.path.join(WORK_DIR, r"model/pre_train/resnet34-333f7ec4.pth"),
    'resnet50': os.path.join(WORK_DIR, r"model/pre_train/resnet50-19c8e357.pth"),
    'resnet101': os.path.join(WORK_DIR, r"model/pre_train/resnet101-5d3b4d8f.pth"),
    'resnet152': os.path.join(WORK_DIR, r"model/pre_train/resnet152-b121ed2d.pth"),
}
