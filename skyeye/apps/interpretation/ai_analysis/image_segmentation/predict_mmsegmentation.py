...
sys.path.append(WORK_DIR+"//mmsegmentation")
import apps.interpretation.ai_config as cg
import utils.common as common
from mmsegmentation.predict_main import predict_result
...
if __name__ == '__main__':
    ...
    # tiff_file_input_path = r'E:\geo_ai_server\c#_test_data\mmseg_data\huzhu\huzhu_small.tif'
    tiff_file_input_path = r'E:\geo_ai_server\c#_test_data\in\in\in_101.tif'
    output_path = r'E:\geo_ai_server\c#_test_data\result\4'
    model_path = r'E:\geo_ai_server\gtrs_cs_server23\model\Segformer_QH_Building_2m_512_iter_350000_voc.pth'
    img_name = 'huzhu'
    pixel = '0.1'
    fragment = '0'
    building_regular = '1'
    ...
    folder_name = '12'
    config_pypath = r'E:\geo_ai_server\gtrs_cs_server23\model\configpy\segformer_mit-b5_qh_building_2m_512x512_160k_voc.py'
    model = init_segmentor(config_pypath, model_path, device='cuda:0')
    segmentation_predict(tiff_file_input_path, output_path, model_path, img_name, pixel, fragment, building_regular,region_field, model, 0, 100, status_num_txt_path)
