...
sys.path.insert(0,os.path.join(WORK_DIR,'utils'))
...
root = r'E:\00_MCD_Test\JiangSu_MCD\Data'
# root=r'E:\05_Test\data'
...
class Data_test1(data.Dataset):
    def __init__(self, path_a,path_b):
        ...
        for img1,img2 in zip(path_a,path_b):
            name = os.path.basename(img1).split('.')[0]
            self.imgs_A.append(io.imread(img1))
            self.imgs_B.append(io.imread(img2))
