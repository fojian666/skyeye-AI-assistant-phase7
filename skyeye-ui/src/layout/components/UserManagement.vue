    ...
    <div class="userManagement">
        <div class="se-skin">
            ...
            <div class="se-skin-menu" v-show="skinMenuVisible" @click.stop>
                <div v-for="(skin, index) in skins" :key="index" class="skin-option" @click.stop="changeSkin(skin)">
                    {{ skin.name }}
                </div>
            </div>
        </div>
        ...
        <div class="user-manage" v-show="active" @mouseenter="clearHideTimer" @mouseleave="startHideTimer">
            <div v-for="(item, index) in pubmanageText" :key="index">
                <div class="pubmanage">
                    <span class="manageText" @click="clickHandle(item.method)">{{ item.name }}</span>
                </div>
            </div>
        </div>
