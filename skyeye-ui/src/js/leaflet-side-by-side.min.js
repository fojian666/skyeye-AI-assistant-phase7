...
})(
    {
        1: [
            function (e, t, n) {
                (function (n) {
                    ...
                    function o(e) {
                        this._refocusOnMap(e), u && this._map.dragging.enable(), p && this._map.tap.enable();
                    }
                    function d(e) {
                    ...
                    e('./layout.css'), e('./range.css');
                    var u, p;
                    (h.Control.SideBySide = h.Control.extend({
                        options: { thumbSize: 42, padding: 0 },
                        initialize: function (e, t, n) {
                            this.setLeftLayers(e), this.setRightLayers(t), h.setOptions(this, n);
                        },
                        getPosition: function () {
                            var e = this._range.value,
                                t = (0.5 - e) * (2 * this.options.padding + this.options.thumbSize);
                        ...
                        remove: function () {
                            return this._map
                                ? (this._leftLayer && (this._leftLayer.getContainer().style.clip = ''),
                                  this._rightLayer && (this._rightLayer.getContainer().style.clip = ''),
                                  this._removeEvents(),
                                  h.DomUtil.remove(this._container),
                                  (this._map = null),
                                  this)
                                : this;
                        },
                        setLeftLayers: function (e) {
                            return (this._leftLayers = d(e)), this._updateLayers(), this;
                        },
                        setRightLayers: function (e) {
                            return (this._rightLayers = d(e)), this._updateLayers(), this;
                        },
                        _updateClip: function () {
                            var e = this._map,
                                ...
                                r = this.getPosition();
                            (this._divider.style.left = r + 'px'), this.fire('dividermove', { x: r });
                        ...
                        _updateLayers: function () {
                            ...
                            (this._leftLayer = this._rightLayer = null),
                                ...
                                t !== this._rightLayer &&
                                    (t && this.fire('rightlayerremove', { layer: t }),
                        ...
                        _addEvents: function () {
                            ...
                            t &&
                                e &&
                                (t.on('move', this._updateClip, this),
                                t.on('layeradd layerremove', this._updateLayers, this),
                                i(e, a(e), this._updateClip, this),
                                i(e, h.Browser.touch ? 'touchstart' : 'mousedown', s, this),
                                i(e, h.Browser.touch ? 'touchend' : 'mouseup', o, this));
                        },
                        _removeEvents: function () {
                            var e = this._range,
                                t = this._map;
                            e &&
                                (r(e, a(e), this._updateClip, this),
                                r(e, h.Browser.touch ? 'touchstart' : 'mousedown', s, this),
                                r(e, h.Browser.touch ? 'touchend' : 'mouseup', o, this)),
        ...
        2: [
            function (e, t, n) {
                ...
                e('./node_modules/cssify')(i, void 0, '/data/github/leaflet-side-by-side/layout.css'), (t.exports = i);
            },
            ...
            function (e, t, n) {
                function i(e, t, n) {
                    ...
                    if (i) n(i);
                        ...
                        (i = e.createElement('style')), (i.id = t), n(i), r.appendChild(i);
                    }
                    return i;
                }
                (t.exports = function (e, t, n) {
                    ...
                    if (r.createStyleSheet) {
                        ...
                        return (a.cssText = e), a.ownerNode;
                    }
                    return i(r, n, function (t) {
        ...
        4: [
            function (e, t, n) {
                ...
                e('./node_modules/cssify')(i, void 0, '/data/github/leaflet-side-by-side/range.css'), (t.exports = i);
            },
            { './node_modules/cssify': 3 }
        ]
    },
