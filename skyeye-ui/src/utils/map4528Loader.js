...
const DEFAULT_PROJ = '+proj=tmerc +lat_0=0 +lon_0=120 +k=1 +x_0=40500000 +y_0=0 +ellps=GRS80 +units=m +no_defs +type=crs';
...
export async function create4528LeafletMap(container, options = {}) {
    ...
    const resolvedCenter = center && center.length === 2 && isFiniteLatLngPair(center[0], center[1]) ? [Number(center[0]), Number(center[1])] : null;
