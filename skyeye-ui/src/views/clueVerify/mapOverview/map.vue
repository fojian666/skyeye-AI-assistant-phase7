<template>
    <div class="gtp-container">
        ...
        <div class="video" :style="{ display: dialogVideoVisible ? 'block' : 'none' }" @mousedown="startDrag" v-show="dialogVideoVisible">
...
import { getMapInfoApi, verifyClueByTaskIDApi } from '@/api/commonApi';
