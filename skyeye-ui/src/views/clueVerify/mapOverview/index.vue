<template>
    <div class="se-container">
        ...
        <div class="right-content">
            <map-component :activeMarker="activeMarker" :activeItem="activeItem" @marker="getMarker" ref="mapComponent"> </map-component>
        </div>
    </div>
</template>
...
import { getOverViewData, getClueData, verifyClueApi, getVerifyTaskParamsApi } from '@/api/commonApi';
