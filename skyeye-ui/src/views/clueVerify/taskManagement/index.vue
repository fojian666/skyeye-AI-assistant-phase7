                        ...
                        <el-form-item label="上传坐标文件:" label-width="110px" style="margin-bottom: 20px; display: flex">
                            <el-input type="text" placeholder="请上传excel" v-model="form.excelfile">
                                <template slot="append">
                                    ...
                                    <input type="file" id="excel" accept=".xlsx, .xls" style="display: none" @change="handleFileUpload" />
                                </template>
                            </el-input>
                        </el-form-item>
                        ...
                        <el-table-column label="操作" align="center">
                            <template slot-scope="scope">
                                <el-button
                                    type="text"
                                    size="medium"
                                    :style="{ color: pushBtnText(scope.row.status)[1] }"
                                    @click="handleCoordinateEdit(scope.row)"
                                    :disabled="scope.row.status === '待拍摄'"
                                    >坐标编辑</el-button
                                >
                                <el-button
                                    type="text"
                                    size="medium"
                                    :style="{ color: pushBtnText(scope.row.status)[1] }"
                                    @click="handleInformationPush(scope.row)"
                                    :disabled="scope.row.status === '待拍摄'"
                                    >{{ pushBtnText(scope.row.status)[0] }}</el-button
                                >
        ...
        <el-dialog
            ...
            <el-form class="form_class">
                ...
                <div class="btn-uploading">
                    <el-button style="margin-right: 20px" type="primary" size="medium" @click="handleAddMarker">添加 </el-button>
