            ...
            <div class="content-body">
                <div class="content-card" v-for="(item, index) in clueList" :key="index">
                    <div style="width: 100%">
                        ...
                        <div class="btn-judge">
                            <el-button size="mini" type="primary" @click="changeStatus(item.id, 2)" :disabled="item.status === 1 || item.status === 2"
                                >有效</el-button
                            >
                            <el-button size="mini" type="danger" @click="changeStatus(item.id, 1)" :disabled="item.status === 1 || item.status === 2"
                                >无效</el-button
                            >
                        </div>
                    </div>
