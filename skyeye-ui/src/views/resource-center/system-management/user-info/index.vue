    ...
    <div class="gt-breadcrumb-cnt">
        <el-form :inline="true" class="add">
            <el-form-item label-width="80px"  label="用户名:" >
                <el-input placeholder="请输入用户名" clearable v-model="queryInfo.query" @clear="getUserList" size="small">
                </el-input>
            </el-form-item>
            <el-form-item>
        ...
        <el-table-column label='状态' align='center' width='100px'>
          <template v-slot='scope'>
            <el-switch v-model='scope.row.is_active' active-color='#13ce66' inactive-color='#ff4949'
                       ...
                       inactive-value='false' @change='userStatusChanged(scope.row)'></el-switch>
          </template>
        </el-table-column>
...
import {
  ...
  deleteUserDataApi, getRoleDataApi,
  getUserListApi,
  postUserDataApi, postUserRoleApi,
  postUserStatusApi,
  putUserDataApi
} from "@/api/commonApi";
