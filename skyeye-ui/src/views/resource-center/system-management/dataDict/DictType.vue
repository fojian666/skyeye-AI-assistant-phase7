            ...
            <el-form :inline="true" class="add">
                ...
                <el-form-item>
                    <el-button type="primary" @click="addDialogVisible = true">
                        <i class="iconfont icon-geoai-add-user"></i>新增字典类型
                    </el-button>
                </el-form-item>
            </el-form>
            <!-- 用户列表 -->
                ...
                <el-table-column label='操作' width='200px' align='center'>
                    <template v-slot='scope'>
                        <el-button type='primary' icon='el-icon-view' size='mini'
                                   @click='showViewDialog(scope.row)'></el-button>
                        <!-- 修改按钮 -->
...
<script>
    ...
    import {
        deleteDictTypeDataApi, getDictTypeListApi,
        getEnumOptionApi, postDictTypeDataApi,
        putDictTypeDataApi,
        postUserStatusApi,
    } from "@/api/commonApi";
