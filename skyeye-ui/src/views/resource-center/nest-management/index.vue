<template>
  <div class="menu-management">
          ...
          <el-table-column label="操作" align="center" width="240" fixed="right">
              <template v-slot="scope">
                  ...
                  <el-button
                          type="danger"
                          size="mini"
                          @click="deleteSoloData(scope.row.id)"
                  >删除
                  </el-button>
              </template>
          </el-table-column>
    ...
    <el-dialog
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="机巢位置" prop="locatiogetn">
          <el-cascader :options="regionOptions"
    ...
    <el-dialog
        ...
        width="30%"
        custom-class="rc-light-dialog"
        left :modal-append-to-body="false">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        name: [
          { required: true, message: '请输入机巢名称', trigger: 'blur' },
        ],
        model: [
          { required: true, message: '请选择或输入机巢型号', trigger: 'change' }
        ],
        nestSn: [
          { required: true, message: '请输入机巢SN', trigger: 'blur' },
        ],
        planeModel: [
          { required: true, message: '请选择或输入飞机型号', trigger: 'change' }
        ],
        planeSn: [
          { required: true, message: '请输入飞机SN', trigger: 'blur' },
        ],
        location: [
          { required: true, message: '请选择机巢位置', trigger: 'blur' },
        ],
        organization: [
          { required: true, message: '请选择或输入所属单位', trigger: 'blur' },
        ],
        longitude: [
