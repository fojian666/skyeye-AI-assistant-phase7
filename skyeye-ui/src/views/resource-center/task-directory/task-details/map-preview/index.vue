<template>
    <a-modal v-model="visible" :dialog-style="{ top: '10vh' }" title="地图预览" width="80vw">
    ...
    methods: {
        ...
        async getTaskById() {
            ...
            if (res.code === 0) {
                ...
                if (
                    (this.dataObj.nextImage && this.dataObj.nextImage.url && this.dataObj.nextImage.url.includes('arcgis')) ||
        ...
        initMap() {
            ...
            this.axios.get(this.url + '.json', { withCredentials: false }).then((res) => {
                ...
                if (this.coordinate_system === '4326' || this.coordinate_system === '4490') {
                    ...
                    transCenter = this.crs.unproject(L.point((parseFloat(minX) + parseFloat(maxX)) / 2, (parseFloat(maxY) + parseFloat(minY)) / 2));
