    ...
    <div class="model-scene-info">
        ...
        <div class="gt-breadcrumb-cnt">
            <el-row :gutter="20" class="add">
                ...
                <el-col :span="4">
                    <el-button type="primary" @click="addDialogVisible = true"><i class="iconfont icon-tianjia"></i>新增模型场景 </el-button>
                </el-col>
            </el-row>
            <!-- 用户列表 -->
                ...
                <el-form label-width="100px" ref="addFormRef" :model="addForm" :rules="addFormRules">
                    ...
                    <el-form-item label="标签类别:" prop="labels">
                        <el-select v-model="addForm.labelRels" placeholder="请选择标签类别" multiple clearable style="width: 100%">
                            <el-option v-for="item in labelList" :key="item.labelValue" :label="item.labelName" :value="item.labelValue"></el-option>
                        </el-select>
                    </el-form-item>
...
import {
    ...
    getModelListNoPageApi,
    getModelLabelListApi,
