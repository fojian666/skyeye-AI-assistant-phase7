<template>
  <div class="library-container">
    <a-card :bordered="false" class="sample-library">
      <div slot="title">
        <span class="iconfont icon-yangbenku card-title-font" />样本库
      </div>
      <div class="library-top">
        <div class="top-left" ref="sampleChart"></div>
        <div class="top-right">
          <div class="title-item">
            <span class="iconfont icon-geoai-line card-title-font" />多维度统计
          </div>
    ...
    <a-card :bordered="false" class="model-library">
      <div slot="title">
        <span class="iconfont icon-shitimoxing card-title-font" />模型库
      </div>
      <div class="library-top">
        ...
        <div class="top-right">
          <div class="title-item">
            <span
              class="iconfont icon-geoai-line card-title-font"
            />遥感智能解译模型平均精度
          </div>
