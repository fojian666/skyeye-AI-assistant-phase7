<template>
    <div style="width: 100%; height: 100%; display: flex">
        ...
        >
            <div
                v-if="embedMode"
                class="embed-map-toggle"
                @click="toggleEmbedMap"
                :title="showSmallMap ? '收起地图' : '展开地图'">
            ...
            <div class="close-chahao" v-if="!embedMode"><el-button icon="el-icon-close" @click="handlebtnclick" class="close-chahao-btn"></el-button></div>
