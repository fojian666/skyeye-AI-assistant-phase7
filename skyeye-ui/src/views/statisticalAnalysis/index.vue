    ...
    <div class="se-container">
                        ...
                        <div class="top-title">
                            ...
                            <div class="btn">
                                <el-button
                                    ...
                                    :style="{
                                        'background-color': activeButton === 'day' ? '#409EFF' : '',
                                ...
                                <el-button
                                    ...
                                    :style="{
                                        'background-color': activeButton === 'week' ? '#409EFF' : '',
                                ...
                                <el-button
                                    ...
                                    :style="{
                                        'background-color': activeButton === 'month' ? '#409EFF' : '',
                                ...
                                <el-button
                                    ...
                                    :style="{
                                        'background-color': activeButton === 'year' ? '#409EFF' : '',
                        ...
                        <div class="top-title">
                            ...
                            <div class="tab-btn">
                                <el-button
                                    ...
                                    :style="{
                                        'background-color': activeButton2 === 'trend' ? '#409EFF' : '',
                                ...
                                <el-button
                                    ...
                                    :style="{
                                        'background-color': activeButton2 === 'type' ? '#409EFF' : '',
        ...
        <div class="bottom-content">
            <div class="condition">
                ...
                <div class="condition-item">
                    <span>开始日期</span>
                    <el-date-picker v-model="condition.start_time" type="date" placeholder="选择日期"> </el-date-picker>
                </div>
                <div class="condition-item">
                    <span>结束日期</span>
                    <el-date-picker v-model="condition.end_time" type="date" placeholder="选择日期"> </el-date-picker>
                </div>
                <div class="condition-item">
            ...
            <div class="table">
                <el-table
                    ...
                    <el-table-column prop="clue_id" label="线索编号" width="180"> </el-table-column>
                    <el-table-column prop="label" label="线索类别" width="180"> </el-table-column>
                    <el-table-column prop="address" label="所属区域"> </el-table-column>
                    <el-table-column prop="create_time" label="发现时间"> </el-table-column>
                    <el-table-column prop="verification_conclusion" label="核查结论"> </el-table-column>
                    <el-table-column label="线索查看">
                    ...
                    <el-table-column prop="status" label="状态">
                        <template slot-scope="scope">
                            <div class="status-cell flexbox">
                                <div :style="{ backgroundColor: getStatusColor(scope.row.status)[0] }" class="status-bg">
                                    {{ getStatusColor(scope.row.status)[1] }}
                                </div>
                            </div>
                        </template>
                    </el-table-column>
                    <el-table-column prop="create_time" label="整改日期"> </el-table-column>
                </el-table>
            </div>
            <el-pagination
                small
...
import { getClueConfirmedTableApi, getCluePictureApi, getClueStatisDataApi, getVillageListApi, statisticsIllegalCluesApi } from '@/api/commonApi';
export default {
    name: 'dataStatics',
    data() {
        return {
