                ...
                <div class="excel-upload">
                    ...
                    <el-form :model="form" ref="form">
                            ...
                            <el-input type="text" placeholder="请上传zip压缩包" v-model="form.shpZipFile"
                                ...
                                <template slot="append">
                                    <el-button icon="el-icon-folder-opened" size="mini"
                                               @click="checkShpZip"></el-button>
                                    <input type="file" id="excel" accept=".zip" style="display: none;"
                                           @change="handleFileUpload" class="custom-input-height"/>
                                </template>
                            </el-input>
                        </el-form-item>
                        ...
                        <el-form-item class="button-container">
                            <el-button class="right-button" type="primary" size="mini" @click="handleSubmit">提交
                            </el-button>
        ...
        <div class="se-right-content">
            ...
            <div class="se-filter-form">
                ...
                <el-form :inline="true" size="medium" :model="filterInfo" ref="filterInfo">
                    <el-form-item>
                        <el-input v-model="filterInfo.task_id" placeholder="请输入任务编号" size="small"
            ...
            <div class="grid-table">
                <!--网格数据-->
                <el-table max-height="100%" height="100%" :data="taskData" stripe style="width: 100%" border
                    ...
                    <el-table-column label="操作" align="center">
                        <template slot-scope="scope">
                            <el-button type="text" size="mini" class="blue" @click="handleDataView(scope.row)">查看
                            </el-button>
                            <el-button type="text" size="mini" class="orange" @click="handleExportReport(scope.row)">导出
                            </el-button>
                        </template>
                    </el-table-column>
                </el-table>
...
<script>
    import {
        postPolygonTaskStatusApi, deleteTaskApi, patternVerifiTableApi, uploadPolygonTaskApi, exportPolygon, JudgeClueApi
    } from '@/api/commonApi';
