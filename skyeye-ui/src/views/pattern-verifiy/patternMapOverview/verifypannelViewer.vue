...
<script>
    ...
    import {
        getPanoramaImageApi, calculatePanoramaApi, getBufferLayerApi, getPointBufferLayerApi,
    } from "@/api/commonApi";
              ...
              this.viewer = pannellum.viewer('panoramaContainer', {
                ...
                this.viewer.on('animatefinished', (event) => {
                  ...
                  if (this.ctx) {
                    ...
                    this.$emit('updateSectorYaw', {currentYaw: this.currentYaw, originYaw: this.yawDegree,currentPitch:this.currentPitch,currentHfov:this.currentHfov});
                });
...
<style scoped>
    ...
    .detectlist, .undetected-region-list {
        margin-top: 10vh;
    ...
    .detectlist .title, .undetected-region-list .title {
        display: flex;
        text-align: center;
    ...
    .detectlist .title span, .undetected-region-list .title span {
        text-align: center;
        font-weight: 700;
        width: 98%
    }
    ...
    ::v-deep .el-form-item--small .el-form-item__content, .el-form-item--small .el-form-item__label {
        line-height: 32px;
        width: 205px;
    }
