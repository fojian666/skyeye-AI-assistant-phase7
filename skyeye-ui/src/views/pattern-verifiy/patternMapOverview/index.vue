<template>
    <div class="se-container" v-if="isShow">
        <div class="left-content-show">
            ...
            <div class="cards-containers">
                <div v-for="(item, index) in patternList" :key="index"
                     :class="{ 'is-active': index === activeCardIndex }" @click="setActiveCard(index,item)"
                     class="card">
        ...
        <div class="right-content-show">
            ...
            <verifypannelViewer class="panoramanic-show"
    ...
    <div class="se-container" v-else style="font-size: 1.5rem;font-weight: bold;padding: 30px">
        请先至任务管理页面查看任务数据
    </div>
</template>
