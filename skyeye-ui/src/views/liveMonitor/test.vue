<template>
  <div class="whip-container">
    <div class="control-bar">
      <el-button type="primary" @click="startPlay" :loading="connecting" :disabled="playing">
        ▶ 开始播放
      </el-button>
      <el-button type="danger" @click="stopPlay" :disabled="!playing && !connecting">
        ⏹ 停止播放
      </el-button>
