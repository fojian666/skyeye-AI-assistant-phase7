        ...
        <div class="left">
            <div class="item-258">
                ...
                <div class="item-content">
                    <div class="cnt-box">
                        <div id="inspectionTaskEchart"></div>
                        <div class="total">
                            <span>任务总量</span>
                    ...
                    <div class="legend">
                        <div v-for="(item, index) in taskData" :key="index" class="legend-content">
                            ...
                            <span>{{ item.name }}</span>
                            <span class="legend-number"> {{ Math.round((item.value / totalValue) * 100) }}% </span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="item-content vertical">
                    <div class="sub-title">
                        ...
                        <div class="sub-title-button">
                            <div class="title-button" :class="{ 'title-button-active': selected === 'month' }" @click="selectMonth" id="month">
                                <span>月</span>
                            </div>
                            <div class="title-button" :class="{ 'title-button-active': selected === 'quarter' }" @click="selectQuarter" id="quarter">
                                <span>季度</span>
                            </div>
                            <div class="title-button" :class="{ 'title-button-active': selected === 'year' }" @click="selectYear" id="year">
                                <span>年</span>
                            </div>
                        </div>
                    </div>
                    <div id="trendStatisticsEchart"></div>
                    <div class="sub-title">
                    ...
                    <div class="typeStatistic">
                        ...
                        <div class="legend">
                            <div v-for="(item, index) in typeData" :key="index" class="type-legend-content">
                                ...
                                <span class="type-legend-number"> {{ Math.round((item.value / typeDataTotal) * 100) }}% </span>
                                ...
                                <div>
                                    <div class="nest-list-item" v-for="item in nestList" :key="item.id">
                                        ...
                                        <div class="nest-item-right">
                                            <img
                                                :src="require(`@/assets/images/portal/${item.status}.png`)"
...
export default {
    ...
    methods: {
        ...
        inspectionTaskStatistics() {
            let myChart = echarts.init(document.getElementById('inspectionTaskEchart'));
            this.taskData = [
                {
                    name: '耕地保护',
                    value: 110,
        ...
        trendStatistics() {
            ...
            let myChart = echarts.init(document.getElementById('trendStatisticsEchart'));
            const option = {
                tooltip: {
                    trigger: 'axis',
                    axisPointer: {
        ...
        typeStatistics() {
            let myChart = echarts.init(document.getElementById('typeStatisticEchart'));
            this.typeData = [
                {
                    value: 600,
                    name: '非农化',
