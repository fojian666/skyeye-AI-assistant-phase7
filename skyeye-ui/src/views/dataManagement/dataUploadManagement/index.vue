        ...
        <div class="gt-right-content">
            <div class="t-query">
                <div class="t-query-items">
                    <div class="t-query-item">
                        ...
                        <el-input placeholder="请输入" v-model="queryConditions.taskName" class="custom-elinput-height"
                                  clearable></el-input>
                    </div>
                    <div class="t-query-item">
                        <span class="idemonstration">数据类型</span>
                        <el-select v-model="queryConditions.taskType" placeholder="请选择" class="custom-elinput-height selectData"
                                   clearable>
                            <el-option
                    ...
                    <div class="t-query-item">
                        ...
                        <el-select v-model="queryConditions.flight" placeholder="请选择"
                                   class="custom-elinput-height" clearable>
                            <el-option
                    ...
                    <div class="t-query-item">
                        ...
                        <el-select v-model="queryConditions.collectType" placeholder="请选择" class="custom-elinput-height"
                                   clearable>
                            <el-option
                    ...
                    <div class="t-query-item">
                        ...
                        <el-select v-model="queryConditions.nest" placeholder="请选择" class="custom-elinput-height selectData"
                                   clearable>
                            <el-option
                ...
                <div class="t-query-button">
                    <el-button type="primary" @click="getTableData" size="mini">
                        查询
                    </el-button>
                    <el-button type="info" @click="resetQuery" size="mini">
                        重置
                    </el-button>
                    <el-button type="danger" @click="handleDeleteView" size="mini">
                        删除
                    </el-button>
                </div>
            </div>
            ...
            <div class="ttable">
                ...
                >
                    ...
                    <el-table-column prop="count" label="数据数量（个）" align="center">
                    ...
                    <el-table-column
                        ...
                        <template slot-scope="scope">
                            <ul class="action-list">
                                <li class="action-item blue" @click="handleView(scope.row)">查看
                                </li>
        ...
        >
            <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                ...
                <el-form-item label="采集方式" prop="collectType"  class="custom-input">
                    <el-select v-model="form.collectType"  clearable
                               :change-on-select="true">
                        <el-option v-for="item in collectTypeOptions" :key="item.value" :label="item.label"
                                   :value="item.value">
                ...
                <div v-if="!dataTypeIsAerialPhoto">
                    <el-form-item label="飞行器" prop="flight" class="custom-input">
                        <el-select
                                ...
                                :change-on-select="true"
                        >
                            <el-option v-for="item in flightList" :key="item.value" :label="item.label"
                                       :value="item.value"></el-option>
                        </el-select>
                    ...
                    <el-form-item label="所属机巢" prop="nest" class="custom-input">
                        <el-select
                                ...
                                :change-on-select="true"
                        >
                            <el-option v-for="item in nestList" :key="item.value" :label="item.label"
                                       :value="item.value"></el-option>
                        </el-select>
                    </el-form-item>
                ...
                <div v-else>
                    <el-form-item label="服务集合" prop="tiffServiceCollection" class="custom-input">
                        <el-select
                                v-model="form.tiffServiceCollection"
                                clearable
                                :change-on-select="true"
                                @change="handleCollectionChange"
                        >
                            <el-option v-for="(files, collection) in collectionIdList"
                                       :key="collection"
                                       :label="collection"
                                       :value="collection"
                            ></el-option>
                    ...
                    <el-form-item label="服务名称" prop="tiffName" class="custom-input">
                        ...
                        >
                            <el-option v-for="(item,index) in tiffInfos" :key="index" :label="item.name"
...
<script>
    import {
        getMultDataApi,getEnumOptionApi,deleteMultDataApi,getRegionInfoListApi,
        getRegionTreeByUser,getNestDataApi,getMultDataDictApi, uploadFileApi,addMultivariateDataApi
    } from "@/api/commonApi";
    ...
    export default {
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    flight: [
                        {required: true, message: '请输入飞行器名称', trigger: 'change'},
                    ],
                    fileList: [
                    ...
                    tiffServiceCollection: [
                        {required: true, message: '请选择服务集合', trigger: 'change'},
                    ],
                    tiffName: [
        ...
        methods: {
            ...
            handleTiffNameChange(selectedCollection){
                const tifinfo = this.tiffInfos.find((item) => {return item.name == selectedCollection})
