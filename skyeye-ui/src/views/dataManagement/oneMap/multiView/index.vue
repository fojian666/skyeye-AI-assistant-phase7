      ...
      <div class="rmain">
        <div class="rm_left">
            <verifypannelViewLeft v-if="pannellumDialogVisible"
                                  :key="uniquekey" :currentObj="currentObj" @angleParam="handleRightAngleParam"
      ...
      <div class="rfoot">
        ...
        <div class="thumbnail-container" >
          <div class="dimg" v-for="(image, index) in currentshowimg" :key="index" @click="handleClickDiv1(image,currentImage)">
            ...
            <el-button type="primary" plain size="mini" :class="{ 'left-active': activeLeftIndex === index }"  @click="handleClickLeft(image,currentImage,index)" :disabled="isAlreadyShownLeft(image)" class="prv-btn">左屏</el-button>
            <el-button type="primary" plain size="mini" :class="{ 'right-active': activeRightIndex === index }" @click="handleClickRight(image,currentImage,index)" :disabled="isAlreadyShownRight(image)" class="next-btn">右屏</el-button>
          </div>
        </div>
