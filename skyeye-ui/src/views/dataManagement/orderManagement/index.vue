      ...
      <div class="t-query">
        <div class="t-query-items">
          <div class="t-query-item">
            ...
            <el-input placeholder="请输入" v-model="queryConditions.orderName" class="custom-elinput-height"
                      clearable></el-input>
          </div>
          <div class="t-query-item">
            <span class="idemonstration">数据类型</span>
            <el-select v-model="queryConditions.dataType" placeholder="请选择" class="custom-elinput-height selectData"
                       clearable>
              <el-option
    ...
    >
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="采集方式" prop="collectType"  class="custom-input">
          <el-select v-model="form.collectType"  clearable placeholder="请选择采集方式"
        ...
        <el-form-item label="选择航线" prop="route"  class="custom-input">
          <el-select v-model="form.route"  clearable placeholder="请选择航线"
                     :change-on-select="true">
            <el-option v-for="item in routeList" :key="item.id" :label="item.name"
                       :value="item.id">
...
<script>
import {
  getOrderListApi,getEnumOptionApi,deleteMultDataApi,getRouteListApi,
  getMultDataDictApi,postOrderInfoApi,getRegionInfoListApi
} from "@/api/commonApi";
