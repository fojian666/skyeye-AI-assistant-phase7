            ...
            <div class="form">
                ...
                <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px"
                    ...
                    <el-form-item label="全景点名称" prop="panoramicPointSetName" class="form-item-vertical">
                        <el-input v-model.number="ruleForm.panoramicPointSetName" autocomplete="off" clearable
                                  class="custom-elinput-height"></el-input>
                    </el-form-item>
                    <el-form-item label="缓冲区半径" prop="radius" class="form-item-vertical">
                        <el-input v-model.number="ruleForm.radius" autocomplete="off" clearable
                                  class="custom-elinput-height"></el-input>
                    </el-form-item>
                    <el-form-item label="区域选择" prop="uploadMethod" class="form-item-vertical">
                        <el-select v-model="ruleForm.uploadMethod" placeholder="请选择检测区域方式" @change="handleSelectChange"
                                   class="custom-elinput-height">
                            <el-option v-for="item in uploadMethodOption" :key="item.value" :label="item.label"
                                       :value="item.value"></el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item label="检测区域矢量" prop="detectAreaShpName" class="form-item-vertical"
                                  v-if="ruleForm.uploadMethod == '1'">
                        <el-input type="text" v-model="ruleForm.detectAreaShpName" autocomplete="off"
                                  class="upload-input custom-elinput-height"></el-input>
                        <el-button class="custom-button" type="primary" icon="el-icon-plus" size="medium" circle
                                   @click="handleDetectionShp"></el-button>
                    </el-form-item>
                    <el-form-item class="search-button">
                        <el-button class="right-button" type="info" size="mini" @click="resetForm('ruleForm')">重置任务
                        </el-button>
                        <el-button class="right-button begin-btn" type="primary" size="mini"
                                   @click="submitForm('ruleForm')">全景点设计
                        </el-button>
                    </el-form-item>
                </el-form>
            </div>
                        ...
                        <el-table-column label="操作">
                            <template slot-scope="scope">
                                <ul class="action-list">
                                    ...
                                    <li class="action-item orange" @click="handleDownload(scope.$index, scope.row)"><i
                                            class="iconfont icon-24px"/></li>
                                    <li class="action-item">|</li>
                                    <li class="action-item red" @click="handleDelete(scope.$index, scope.row)"><i
                                            class="iconfont icon-shanchu"/></li>
                                </ul>
                            </template>
                        </el-table-column>
                    </el-table>
