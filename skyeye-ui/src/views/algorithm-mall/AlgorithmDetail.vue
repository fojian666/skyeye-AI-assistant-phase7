        ...
        <div class="model-des">
            ...
            <el-row :gutter="20">
                <el-col :span="8" v-for="(item, index) in modelDes" :key="index">
                    <h2>
                        <i class="fa el-icon-caret-right"></i> <!-- 使用i标签作为图标 -->
                        {{ item.title }}
                    </h2>
    ...
    export default {
        ...
        data(){
            return{
                ...
                algorithms: [
                    { id:0,image: require('@/assets/images/algorithm-mall/bg1.jpg'), tag: '', title: '反光衣识别', description: '智慧交通 智慧城管 建筑地产'},
                    { id:1,image: require('@/assets/images/algorithm-mall/bg1.jpg'), tag: '新品', title: '渣土车识别', description: '智慧工业 建筑地产' },
                    { id:2,image: require('@/assets/images/algorithm-mall/bg1.jpg'), tag: '热门', title: '反光衣识别', description: '智慧交通 智慧城管 建筑地产'},
