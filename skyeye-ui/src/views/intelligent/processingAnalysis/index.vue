        ...
        <div class="t-query-items">
          ...
          <div class="t-query-item">
            ...
            <el-select v-model="taskState" placeholder="请选择" class="custom-input-height" clearable>
              <el-option
                  v-for="item in regionOtionsState"
                  :key="item.value"
                  :label="item.name"
                  :value="item.value"
                  clearable
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <ul class="action-list">
                <li class="action-item blue" @click="skipToVerifyClue(scope.row)"><i class="iconfont icon-geoai-look"/>
                </li>
...
import {
  ...
  getRegionOptions,
  addBatchTask,
  batchDeleteTaskApi, getDictByType,
} from "@/api/commonApi";
