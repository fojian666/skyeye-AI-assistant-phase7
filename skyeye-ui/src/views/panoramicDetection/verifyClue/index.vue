                ...
                <el-form :model="formInfo">
                    ...
                    <el-form-item>
                        ...
                        <el-select style="width: 85px; margin: 0 5px" v-model="formInfo.hadClue" clearable>
                            <el-option v-for="item in filterHadClueList" :key="item.value" :label="item.label" :value="item.value"></el-option>
                        </el-select>
                    </el-form-item>
                </el-form>
            </div>
            <div class="vcards">
                <div v-for="(item, index) in cards" :key="index" class="vcard" :style="borderStyle(index)" @click="handleCardClick(index, item)">
...
import { getCurrentPageVerifyClueQuanjingPointsApi, getAllPanoramaImageByBatchIdApi } from '@/api/commonApi';
export default {
    name: 'VerifyClue',
    ...
    methods: {
        ...
        updateParentAllLayersCheck(value) {
            //这个是单景查看更新该index的图层信息
