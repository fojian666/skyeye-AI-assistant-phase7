            ...
            <div class="right-content-body">
                <div class="filter">
                    ...
                    <el-form :inline="true" size="small" :model="filterInfo" ref="filterInfo">
                        ...
                        <el-form-item>
                            <el-input type="text" placeholder="请输入批次编号" clearable v-model="filterInfo.keyword"></el-input>
                        </el-form-item>
                        <el-form-item>
                ...
                <div class="report-cards">
                    ...
                    <div class="content-card" v-for="item in reportData" :key="item.report_id">
                        ...
                        <div @click="reportDownload(item)">
                            ...
                            <img src="@/assets/images/icon-new.png" class="newest" v-if="item.report_id === latest_task_id" />
