          ...
          <el-table :data="tableDataList" border @selection-change="handleSelectionChange" max-height="100%" height="100%">
            ...
            <el-table-column prop="percent" label="检测进度" align="center">
              <template slot-scope="scope">
                <el-progress :percentage="scope.row.percent" :status="getStatus(scope.row.percent)" style="text-align: left"></el-progress>
              </template>
            </el-table-column>
            <el-table-column label="操作" width="150px" align="center">
              <template slot-scope="scope">
                <ul class="action-list">
                  <li class="action-item1" @click="handleDownload(scope.row)" v-if="scope.row.status === 2 || scope.row.status === 0">
