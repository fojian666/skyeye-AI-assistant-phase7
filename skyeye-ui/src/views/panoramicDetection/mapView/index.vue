    ...
    <div class="se-mv-container">
        <div class="left-content">
            ...
            <div class="se-filter-form">
                ...
                <el-form :model="formInfo">
                    <el-form-item style="display: flex">
                        <el-input placeholder="请输入关键字" v-model="formInfo.keyword"
                    ...
                    <el-form-item>
                        ...
                        <el-select style="width: 90px; margin: 0 4px" v-model="formInfo.grid_name" clearable>
                            <el-option v-for="item in gridNameList" :key="item.value" :label="item.name"
                    ...
                    <el-form-item>
                        <el-date-picker type="daterange" style="width: 315px; margin: 0 5px 0 0"
            ...
            <div class="cards-container">
                <div v-for="(item, index) in clueList" :key="index" :class="{ 'is-active': index === activeCardIndex }"
        ...
        <div class="right-content">
            <map-component :activePanoramaPoint="activePanoramaPoint"
...
<script>
    ...
    export default {
        ...
        async created() {
            ...
            if (this.$route.query.grid_id)
                this.formInfo.grid_name = this.$route.query.grid_id;//跳转的网格名称
            await this.getClue()
            this.$refs.mapComponent.updateCluesList(this.clueList)
        },
        computed: {},
