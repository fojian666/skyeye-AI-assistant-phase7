            ...
            <div class="container">
                ...
                <section class="upload-btn-section">
                    <div class="upload-btn-wrap">
                        <el-button type="primary" icon="el-icon-upload" size="medium" @click="triggerFileInput('left')" class="single-upload-btn">
                            上传第一期全景图（前景）
                        </el-button>
                        <el-button type="success" icon="el-icon-upload" size="medium" @click="triggerFileInput('right')" class="single-upload-btn">
                            上传第二期全景图（后景）
                        </el-button>
                    </div>
                    <!-- 隐藏的文件输入框 -->
                ...
                <section class="upload-section">
                    ...
                    <div class="upload-card">
                        ...
                        <div class="file-info" :class="{ active: uploadedImages.left }">
                            ...
                            <el-button type="danger" icon="el-icon-delete" size="mini" @click="resetPanorama('left')"> 移除 </el-button>
                        </div>
                    </div>
                    ...
                    <div class="upload-card">
                        ...
                        <div
                            ...
                            <div
                                ...
                                :class="{ active: uploadedImages.right || isDefaultImg === '1' }"></div>
                        ...
                        <div class="file-info" :class="{ active: uploadedImages.right }">
                            ...
                            <el-button type="danger" icon="el-icon-delete" size="mini" @click="resetPanorama('right')"> 移除 </el-button>
                        </div>
                    </div>
                </section>
                ...
                <section class="detect-section">
                    ...
                    <p class="detect-hint" v-show="!isBothUploaded">请先上传两期全景图像</p>
                </section>
                ...
                <section class="result-section" v-show="showResult">
                    <div class="result-header">
                        ...
                        <el-tag type="success" class="confidence-badge"> <i class="el-icon-check-circle confidence-icon"></i> 检测完成 </el-tag>
                    </div>
...
export default {
    ...
    methods: {
        ...
        handleDetect() {
            ...
            axios
                .post('/api/panorama/change-detection', formData, {
