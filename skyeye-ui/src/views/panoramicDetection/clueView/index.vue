        ...
        <div class="content">
            ...
            <div class="filter">
                <div class="filter-header">
                    ...
                    <div class="filter-header-right">
                        <p style="margin-right: 16px">
                            已筛选出<span style="color: red">{{ dataCount }}</span
                            >条数据
                        </p>
                    </div>
                </div>
                ...
                <div class="filter-content">
                    ...
                    <div class="status-list">
                        <span
                            v-for="(item, index) in clueCategory"
                            :key="index"
            ...
            <el-dialog :visible.sync="cardDetailVisible" width="20%" class="card-detail" :close-on-click-modal="false" :show-close="false">
                <template slot="title">
                ...
                <div class="card-detail-content">
                    <img @click="imgVisible = true" style="width: 100%; height: 200px; object-fit: contain" :src="cardDetailInfo.image_path" />
            ...
            <el-dialog class="img-dialog" :visible.sync="imgVisible" width="60%" :show-close="false">
                <template slot="title">
                    <div class="card-detail-title" style="display: flex; align-items: center; justify-content: space-between">
                        <div style="display: inline-block">
                            <span class="iconfont icon-xinzengtianjia" style="margin-right: 5px"></span>
            ...
            <el-dialog class="map-dialog" :visible.sync="mapVisible" width="60%" :show-close="false" :close-on-click-modal="false">
                <template slot="title">
                    <div class="card-detail-title" style="display: flex; align-items: center; justify-content: space-between">
                        <div style="display: inline-block">
                            <span class="iconfont icon-xinzengtianjia" style="margin-right: 5px"></span>
            ...
            <el-dialog class="export-dialog" :visible.sync="isShowExportDialog" width="60%" @close="resetForm" title="线索导出筛选">
                <el-form size="medium" :model="exportForm" ref="form" class="export-form">
                    <el-form-item label="线索状态" prop="clueStatus" class="custom-input" label-width="100px">
                        <el-select v-model="exportForm.clueStatus" clearable placeholder="请选择线索状态" :change-on-select="true">
                            <el-option v-for="item in checkStatus" :key="item.value" :label="item.name" :value="item.value"> </el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item label="线索标签" prop="clueType" class="custom-input" label-width="100px">
                        <el-select v-model="exportForm.clueType" clearable placeholder="请选择线索标签" :change-on-select="true">
                            <el-option v-for="item in clueCategory" :key="item" :label="item" :value="item"> </el-option>
                        </el-select>
                    </el-form-item>
...
<script>
import { getClueOverviewApi, getEnumOptionApi, getMapInfoApi, getSceneData } from '@/api/commonApi';
