            ...
            <el-row :gutter="20">
                <el-col :span="14">
                    <div class="grid-content bg-purple">
                        <a-card :bordered="true">
                            <div slot="title">
                                <span class="iconfont icon-geoai-ad-line card-title-font"/>全景数量统计
                            </div>
                ...
                <el-col :span="6">
                    <div class="grid-content bg-purple">
                        <a-card :bordered="true">
                            <div slot="title">
                                <span class="iconfont icon-geoai-ad-line card-title-font"/>违法线索发现排行
                            </div>
            ...
            <el-row :gutter="20">
                <el-col :span="8">
                    <div class="grid-content bg-purple">
                        <a-card :bordered="true">
                            <div slot="title">
                                <span class="iconfont icon-geoai-ad-line card-title-font"/>违法线索统计
                            </div>
                ...
                <el-col :span="8">
                    <div class="grid-content bg-purple">
                        <a-card :bordered="true">
                            <div slot="title">
                                <span class="iconfont icon-geoai-ad-line card-title-font"/>累计违法线索分布情况
                            </div>
                            <div id="chart3" class="card-content">
                ...
                <el-col :span="8">
                    <div class="grid-content bg-purple">
                        <a-card :bordered="true">
                            <div slot="title">
                                <span class="iconfont icon-geoai-ad-line card-title-font"/>报告下载
                            </div>
                            <div  class="card-content">
...
<style scoped>
    ...
    .card-right-top,.card-right-middle,.card-right-bottom{
        width:100%;
        margin-bottom: 10px;
        height:118px;
    }
