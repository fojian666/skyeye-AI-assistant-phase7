            ...
            <div class="left-form">
                ...
                <div class="check-box">
                    ...
                    <div class="file-upload">
                        <span>文件上传：</span>
                        <el-upload class="upload-demo" :action="fileUploadUrl" :headers="headers" accept=".zip" :limit="1"
                                   :file-list="fileList"
                                   :on-success="getUploadFile" :on-remove="handelRemoveFile">
                    ...
                    <div class="street">
                        <span>资源选择：</span>
                        <el-select v-model="tempForm.resourceIdList" placeholder="请选择" style="width: 220px" multiple
                                   clearable>
                            <el-option
        ...
        <div class="se-right-content">
            ...
            <div class="right-content-body">
                ...
                <div class="se-data-table">
                    <el-table :data="projects" border @selection-change="handleSelectionChange" max-height="100%"
                              height="100%">
                        ...
                        <el-table-column prop="clue_count" label="待核实线索数(个)" align="center"
                        ...
                        <el-table-column prop="percent" label="检测进度" align="center">
                            <template slot-scope="scope">
                                <el-progress :percentage="scope.row.percent" :status="getStatus(scope.row.percent)"
...
<script>
    import {
        deleteUploadByIdApi, getAutoCreateBatchApi, getDownloadAnalysisInfoApi,
        getResourceListsApi,
        getUploadBatchData,
        getUploadProgress, tempAddUploadBatchApi
    } from "@/api/commonApi";
