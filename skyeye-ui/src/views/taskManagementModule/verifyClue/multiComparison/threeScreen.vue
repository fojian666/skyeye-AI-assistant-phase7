...
<script>
    ...
    import verifypannelViewLeft from "@/views/taskManagementModule/verifyClue/multiComparison/verifypannelViewLeft.vue";
    import verifypannelViewRight from "@/views/taskManagementModule/verifyClue/multiComparison/verifypannelViewRight.vue";
