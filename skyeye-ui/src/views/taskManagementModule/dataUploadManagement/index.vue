...
<!--                        <el-input v-model="form.flight"></el-input>-->
                        <el-select
                                ...
                                :change-on-select="true"
                        >
                            <el-option v-for="item in cameraInfoOptions" :key="item.value" :label="item.label"
                                       :value="item.value"></el-option>
                        </el-select>
...
<script>
    import {
        ...
        getNestDataApi,getMultDataDictApi, uploadFileApi,addMultivariateDataApi
    } from "@/api/commonApi";
    ...
    export default {
        ...
        watch: {
            ...
            '$route.query.autoUpload'(val) {
                if (val === '1' || val === 1) {
                    this.tryAutoOpenUpload();
                }
            },
        },
        methods: {
            ...
            tryAutoOpenUpload() {
                const { autoUpload, taskName } = this.$route.query;
                if (autoUpload !== '1' && autoUpload !== 1) return;
                if (taskName) {
