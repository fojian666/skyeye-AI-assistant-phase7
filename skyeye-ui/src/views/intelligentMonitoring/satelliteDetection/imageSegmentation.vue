...
export default {
    ...
    methods: {
        initMap() {
            ...
            this.mapLayer = new TiledMapLayer(this.currentLayer.url, { noWrap: true }).addTo(this.map);
            // 添加放大缩小控件
        ...
        inference() {
            ...
            // 开始预测
            let overlayAnalystService = spatialAnalystService(this.currentLayer.analyticalUrl);
            ...
            overlayAnalystService.overlayAnalysis(datasetOverlayAnalystParameters, function (serviceResult) {
                ...
                if (serviceResult.type == 'processCompleted' && typeof serviceResult.result.recordset != 'undefined') {
                    than.predictLayer = L.geoJSON(serviceResult.result.recordset.features.features, {
