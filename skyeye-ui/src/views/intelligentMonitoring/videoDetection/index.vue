    ...
    <div class="se-container">
        <div class="main-content">
            <div class="left-content">
                ...
                <div class="left-content-bottom">
                        ...
                        <div style="height: 20%"
                                ...
                                :key="index"
                        >
                            <cards :data="item" @open-task-details="openTaskDetails"
            ...
            <div class="right-content">
                <ve-details v-show="showDetails" :oddata="selectedCardData" :key="detailsKey"
                            @openTaskDetails="openTaskDetails"></ve-details>
            ...
            <div style="width: 100%; height: 39vh; padding-top: 10px">
                <el-form class="form_class">
                    ...
                    <el-form-item label="本地上传:" label-width="100px" v-if="uploadmethod==='local'">
                        <el-input type="text" placeholder="支持本地上传视频文件" v-model="filePath">
                            <template slot="append">
                                ...
                                <input type="file" id="fileinput" style="display: none;" accept="video/mp4"
                                       @change="handleFolderSelection"/>
                            </template>
                        </el-input>
                    </el-form-item>
                    <el-form-item v-else label="服务器上传:" label-width="100px">
                        <el-select v-model="selectedFile" placeholder="请选择" @change="handleFileSelection"
                                   style="width:100% ">
                            <el-option
                                    v-for="item in serverPathList"
                                    :key="item"
                                    :label="item"
                                    :value="item">
                            </el-option>
                    ...
                    <div class="btn-uploading">
                        <el-button style="margin-right: 20px" type="primary" size="medium" @click="sumfolder">解译<i
...
<script>
    ...
    import {
        getFileFolder,getTaskDataListApi,getMapInfoApi
    } from "@/api/commonApi";
