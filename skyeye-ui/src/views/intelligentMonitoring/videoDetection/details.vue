<template>
    <div class="gtp-container">
        <div class="detection-filter">
            <div class="filter-all">
                ...
                <div class="filter-checkb">
                    <el-checkbox-button :indeterminate="isClassIndeterminate" v-model="classcheckAll"
                                        class="filter-checkb-all">全选
                    </el-checkbox-button>
                    <el-checkbox-group v-model="checkedclass">
                        <el-checkbox-button v-for="item in classes" :label="item" :key="item"
                                            class="filter-checkb-item">{{ item }}
                        </el-checkbox-button>
                    </el-checkbox-group>
                </div>
            </div>
            <div class="filter-all">
                ...
                <div class="filter-checkb">
                    <el-checkbox-button :indeterminate="isIndeterminate" v-model="labelcheckAll"
                                        class="filter-checkb-all">全选
                    </el-checkbox-button>
                    <el-checkbox-group v-model="checkedlabels">
                        <el-checkbox-button v-for="label in labels" :label="label" :key="label"
                                            class="filter-checkb-item">{{ label }}
                        </el-checkbox-button>
                    </el-checkbox-group>
                </div>
            </div>
        ...
        <div v-if="this.oddata.pictures.length != 0" class="picture-body">
                    ...
                    >
                        <div class="flex-container">
                            <div class="card-body">
                                ...
                                <el-button class="xqbtn" type="primary" plain size="small"
                                           @click="openimagemap(picture)"
                                >详情
                                </el-button>
                            </div>
                        </div>
...
<script>
    ...
    export default {
        ...
        // },
        //     mounted() {
        //         console.log('oddata:', this.oddata);
        //
        //     },
        computed: {
        ...
        methods: {
            openTaskDetails() {
                this.$emit('openTaskDetails', this.oddata); // 触发事件
            },
            ...
            getImageUrl(picture) {
                return [this.baseUrl + `/${picture.result_path}`];
            },
