        ...
        <div class="detection-filter">
            <div class="filter-all">
                ...
                <div class="filter-checkb">
                    <el-checkbox-button :indeterminate="isClassIndeterminate" v-model="classcheckAll" class="filter-checkb-all"
                        >全选
                    </el-checkbox-button>
            ...
            <div class="filter-all">
                ...
                <div class="filter-checkb">
                    <el-checkbox-button :indeterminate="isIndeterminate" v-model="labelcheckAll" class="filter-checkb-all">全选 </el-checkbox-button>
