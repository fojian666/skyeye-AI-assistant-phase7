<template>
    <div id="panoramaContainer" style="position: relative">
        ...
        <el-dialog title="检测列表" :visible.sync="dialogTableVisible" center class="gt-od-list-data"
        ...
        >
            <el-form class="form_class">
                ...
                <div class="btn-uploading">
                    <el-button style="margin-right: 20px" type="primary" size="medium" @click="addOdLabel">添加
                    </el-button>
    ...
    export default {
        ...
        data() {
            return {
                ...
                currentClass: '',
                classList: [
                    '大巴', '堆土', '脚手架', '翻土机', '翻斗车', '钢筋', '水泥地坪',
                    '挖掘机', '堆砖', '火焰', '推土车', '彩钢瓦', '搅拌机', '物料提升机',
                    '起重机', '小轿车', '围挡', '压路车', '打桩机',
                    '在建砖房', '运输车', '树', '搅拌车', '烟雾', '防尘网', '板房棚房',
                    '塔吊', '水泥管', '工程管', '工程车辆'
                ],
                currentIndex: 1,
