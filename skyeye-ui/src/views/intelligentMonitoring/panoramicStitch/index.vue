        ...
        <div class="main-content">
            <div class="left-content">
                <div v-if="isProject">
                            ...
                            <el-form-item>
                                <el-input type="text" placeholder="请输入项目名称" v-model="searchName">
                                    <template slot="append">
                                        <el-button icon="el-icon-search" size="medium" @click="searchProject"></el-button>
                                    </template>
                                </el-input>
                            </el-form-item>
                        </el-form>
                    ...
                    <div class="left-content-bottom">
                        <div style="height: 20%" v-for="(item, index) in displayProj" :key="index">
                ...
                <div v-if="isTask">
                    <div class="left-content-top-task">
                        <div>
                            <i class="el-icon-back" @click="goBack" style="font-size: 16px"></i>
                    ...
                    <div class="left-content-bottom">
                        <div v-for="(item, index) in taskList" :key="index">
                            <cards :data="item" @open-pannellumViewer="openpannellumViewer" @remove="removeCard(index)" />
                        </div>
                    </div>
            ...
            <div class="right-content">
                <pannellumViewer
                    ...
                    @open-pannellumViewer="openpannellumViewer"
                    :key="uniquekey"
                    :currentObj="currentObj"
                    :taskList="taskList"></pannellumViewer>
                ...
                <el-form class="form_class">
                    ...
                    <el-form-item label="文件上传:" label-width="100px">
                        <el-input type="text" placeholder="请上传文件夹" v-model="folderPath">
                            <template slot="append">
                                <el-button icon="el-icon-folder-opened" size="medium" @click="checkFile"></el-button>
                                <input type="file" id="fileinput" webkitdirectory style="display: none" @change="handleFolderSelection" />
                            </template>
                        </el-input>
                    </el-form-item>
                    <el-form-item label="操作人员:" label-width="100px">
                    ...
                    <div class="btn-uploading">
                        <el-button style="margin-right: 20px" type="primary" size="medium" @click="inference"
