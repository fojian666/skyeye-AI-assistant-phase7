<template>
    <div class="gtp-container">
        <div class="detection-filter">
            <div class="filter-all">
                ...
                <div class="filter-checkb">
                    <el-checkbox-button :indeterminate="isClassIndeterminate" v-model="classcheckAll" @change="handleClassCheckAllChange" class="filter-checkb-all">全选</el-checkbox-button>
                    <el-checkbox-group v-model="checkedclass" @change="handleCheckedClassChange">
                        <el-checkbox-button v-for="item in classes" :label="item" :key="item" class="filter-checkb-item">{{item}}</el-checkbox-button>
                    </el-checkbox-group>
                </div>
            </div>
            <div class="filter-all">
                ...
                <div class="filter-checkb">
                    <el-checkbox-button :indeterminate="isIndeterminate" v-model="labelcheckAll" @change="handlelabelCheckAllChange" class="filter-checkb-all">全选</el-checkbox-button>
                    <el-checkbox-group v-model="checkedlabels" @change="handleCheckedlabelsChange">
                        <el-checkbox-button v-for="label in labels" :label="label" :key="label" class="filter-checkb-item">{{label}}</el-checkbox-button>
                    </el-checkbox-group>
                </div>
            </div>
        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="image-container">
                                    <el-image
                                            ...
                                            fit="fill"
                                            :preview-src-list="getImageUrl(picture)"
                                    ></el-image>
                                </div>
                                ...
                                <el-button class="xqbtn" type="primary" plain size="small" @click="openimagemap(picture)"
                                >详情</el-button>
                            </div>
                        </div>
                    </el-card>
        ...
        <el-dialog
                :visible="isImageMapDialogVisible"
                @close="clossImageMapDialog"
                width="80%"
                center
        >
            <template slot="title">
