    ...
    <div class="se-container">
        <div class="main-content">
            <div class="left-content">
                <div style="position: relative">
                    ...
                    <div class="left-content-bottom">
                        <div style="height: 20%" v-for="(item, index) in dataList" :key="index">
            ...
            <div class="right-content">
                ...
                <od-details v-show="showDetails" :oddata="selectedCardData" :key="detailsKey" @openTaskDetails="openTaskDetails"></od-details>
                    ...
                    <el-form-item label="文件上传:" label-width="100px">
                        <el-input type="text" placeholder="请上传图片文件" v-model="filePath">
                            <template slot="append">
                                ...
                                <input type="file" id="fileInput" style="display: none" @change="handleFolderSelection" />
                            </template>
                        </el-input>
                    </el-form-item>
