    ...
    <div>
        <div class="toolbar-management" >
            <div class="draw-content" v-if="!isCollapsedToolBar">
                <div @click="changeBarIndex(1)"
                     :class="{ activateManagebar: activeToolIndex === 1 }"
                     v-if="!oneMapSingle"
                >
                ...
                <div @click="openCounty" v-show="isShowArea"><span class="icon iconfont icon-map-marker icon-toolbar"></span>
                    <span class="toolbar-text">区划定位</span>
                </div>
                <span style="color: #cccccc">|</span>
                <div @click="resetBar"><span class="icon iconfont icon-qingchu icon-toolbar"></span>
