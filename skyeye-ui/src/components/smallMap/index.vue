...
import { getClueData, getOneMapApi, getPanoramaPointByCountryApi, getTopViewDataApi, submitCorrectPointApi } from '@/api/commonApi';
...
export default {
    ...
    methods: {
        ...
        async loadGeoserverVectorData() {
            ...
            const urlString = this.needAddService ? `${this.needAddService}/${workspace}` : `${geoserverBase}/${workspace}`;
            try {
            ...
            if (res.code === 0) {
                ...
                this.$nextTick(() => {
                    if (para.time === '') {
                        ...
                        defaultDisplayDataList.push(panorama, panoramaCoverage, nestLocation, nestCoverage, aerialPhoto);
